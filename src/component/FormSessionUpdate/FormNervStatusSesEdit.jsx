...
const FormNervStatusEdit = ({ nervStatus, setNervStatus }) => {
    return (
        <>
            <div className="row">
                ...
                <div className="mb-3 col">
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            setNervStatus({
                                ...nervStatus,
                                meningit: e.target.value,
                            })
                        }
                    >
                        <option defaultValue>Выберите вариант</option>
                        <option value="Ригидность затылочных мышц">
...
export default FormNervStatusEdit;
