...
const FormPsychStatusEdit = ({ psychStatus, setPsychStatus }) => {
    return (
        <>
            <div className="row">
...
export default FormPsychStatusEdit;
