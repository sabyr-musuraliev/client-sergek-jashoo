...
const FormSomatStatusEdit = ({ somatStatus, setSomatStatus }) => {
    return (
        <>
            <div className="row">
            ...
            <div className="row">
                <div className="mb-3 col">
                    <label className="form-label">
                        Следы старых и свежих ссадин, ушибов, гематом, парезов,
                        воспаления
                    </label>
                    <textarea
            ...
            <div className="row">
                <div className="mb-3 col">
                    <label className="form-label">
                        Состояние периферической сосудистой системы
                    </label>
                    <textarea
                        className="form-control"
                        rows="1"
...
export default FormSomatStatusEdit;
